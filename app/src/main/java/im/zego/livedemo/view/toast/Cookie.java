...
import im.zego.livedemo.view.toast.CookieBarDismissListener.DismissType;
...
//        actionButton = findViewById(R.id.btn_action);
    ...
    public void setParams(final CookieBar.Params params) {
        ...
        if (params.backgroundColor != 0 && layoutCookie != null) {
            layoutCookie
        ...
        if (layoutGravity == Gravity.BOTTOM && layoutCookie != null) {
